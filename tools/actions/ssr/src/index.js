...
import { decorateMain, toMjml, init as initLibFranklin } from '@adobe/helix-project-boilerplate/scripts/functions.js';
...
export async function main(params) {
  const url = params.__ow_path ? params.__ow_path.substring(1) : 'main--sites-newsletter--buuhuu.hlx.live';
